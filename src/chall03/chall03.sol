...
contract hero2301 is IERC20, Ownable
{
    ...
    function transferFrom( //@audit transfer moula from owner to me
        address sender, //need to find the recipient
        address recipient,
        uint amount
    ...
    function mint(uint amount) external { //@audit-info HS cause add doesn't update the variable
